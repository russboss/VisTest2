...
{ 
	public float setupSpinSpeed = 0f; //50.0f; 
	...
	public Color blue = new Color(255,62,125,231); // Color.blue; 
	public Color green = new Color(255, 64, 200, 64); // Color.green; 
	...
	{ 
		// 		if(other.gameObject.name == "GoodOrb")
	...
	{ 
		// if(collidedWith.gameObject.name == "BadOrb")
